 ...
 */
public class MQTTDataTransformation {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (args.length > 0) {
                ...
                configFilePath = "../config/MQTT.json";
            }
            ...
            try {
                ...
                MQTTPerformanceConsumerWithDataTransformation cons = new MQTTPerformanceConsumerWithDataTransformation(mqtt, config);
