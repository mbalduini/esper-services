    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (args.length > 0) {
                ...
                configFilePath = "../config/Avro-MQTT.json";
            }
            ...
            try {
                ...
                MQTTPerformanceConsumerBremboEvent cons = new MQTTPerformanceConsumerBremboEvent(mqtt, config);
